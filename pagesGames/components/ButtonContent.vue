<template>
	<view class="ButtonContent">
		<view class="firstRow">
			<button type="primary" class="buttonClass" v-for="item in buttonFirstRow" :key="item"
				@click="buttonClick(item)">{{ item }}</button>
		</view>
		<view class="secondRow">
			<button type="primary" class="buttonClass" v-for="item in buttonSecondRow" :key="item"
				@click="buttonClick(item)">{{ item }}</button>
		</view>
	</view>
</template>
